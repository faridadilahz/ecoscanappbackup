...
Widget build(BuildContext context) {
    ...
    body: SafeArea(
      child: Column(
        children: [
          ...
          Expanded(
            child: AnimatedSwitcher(
              ...
              child: _isSuccessPage
                  ...
                  : _buildStepPage( // Button sekarang dipanggil di dalam sini
                      _steps[_currentPage],
          ...
          // HAPUS _buildBottomNavigation() dari sini!
        ],
      ),
    ),
  );
  ...
  return SingleChildScrollView( // Tambahin ini biar kalau layar pendek ga error
    child: Container(
      key: key,
      ...
      child: Column(
        ...
        children: [
          const SizedBox(height: 10), // Jarak dikit dari header
          ...
          Image.asset(
            ...
            errorBuilder: (context, error, stackTrace) => const Icon(
              Icons.image_outlined, size: 100, color: Colors.black12,
            ),
          ),
          ...
          const SizedBox(height: 40), // Jarak dari teks ke Button

          // MASUKKAN NAVIGASI DI SINI
          _buildBottomNavigation(), 
          
          const SizedBox(height: 24), // Tambahan padding bawah
        ],
      ),
    ),
  );
                  ...
                  onPressed: () {
                    setState(() {
                      if (isFirstPage) {
                        Navigator.pop(
                          context,
                        ); // Jika di Langkah 1, balik ke overview
                      } else {
            ...
            TextButton(
              onPressed: () {
                setState(() {
                  _currentPage =
                      _steps.length -
                      1; // Kembali ke index 5 (Langkah 6) via dissolve
                });
              },
